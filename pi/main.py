...
the other to handle the PSVD software.
...
try:
    ...
    # setup_data does not exist
    print "ERROR: setup_data.py does not exist. Run ./psvd_setup.py first."
    sys.exit(1)
...
class MainApplication(tk.Frame):
    ...
    def __init__(self, master = None):
        ...
        # populate the application with widgets
