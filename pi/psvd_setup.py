...
# ==============================================================================           
    ...
    def saveData(self):
        ...
        tkMessageBox.showinfo(title = "PSVD Setup", 
...
# ==============================================================================
    def clickStart(self):
        ...
        if not self.__is_saved:
            response = tkMessageBox.askyesno(
                ...
                + "Would you like to save before running PSVD?"
                )
        ...
        # data is saved, ask the user if they are sure they wish to quit.
            ...
            response = tkMessageBox.askyesno(
                title = "Save Setup",
                message = "Are you ready to leave setup and run PSVD?"
                )
        
        # user wishes to quit setup and run PSVD, so do it!
        if response:
    ...
    def clickNewImage(self):
        """Use PiCam to take new 'setup image' for PSVD setup. """
...
# ==============================================================================  
    ...
    def __createMenu(self):
        ...
        self.start_button = tk.Button(self, text = "Start PSVD",
        ...
        # about button - display information about PSVD
