...
<script type="text/javascript">
	function updateParkField(id, name, desc, spaces, location) {
		...
		$('#park_form_title').html('Edit Lot #' + id);
	}
</script>

<form class="form-signin" role="form" action="parkaction.php" method="POST">
	<h2 id="park_form_title" class="form-signin-heading">Add Lot</h2>
	...
	<textarea id="park_desc" name="park_description" class="form-control form-control-last" placeholder="Lot Description"></textarea>
